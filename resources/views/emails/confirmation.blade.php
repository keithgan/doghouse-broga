...
<head>
  ...
  <style>
    ...
    .footer { max-width: 600px; margin: 40px auto 0; text-align: center; font-size: 14px; color: #666; padding: 20px; line-height: 1.6; }
...
<body>
  ...
  <div class="footer">
    <p>Thank you for your booking! We will get back to you within <strong>3 working days</strong> to confirm your reservation.</p>
    <p>Warm regards,<br><strong>Doghouse Broga</strong></p>
  </div>
</body>
</html>