...
class BookingController extends Controller
{
    ...
    public function submitForm(Request $request)
    {
        $validated = $request->validate([
            // Owner Details
            // 'first_name' => 'required|in:never-valid', // always fails
        ...
        Mail::to($booking['email'])->queue((new BookingConfirmation($booking))->from('enquiries@doghousebroga.com', 'Doghouse Broga'));
        
        // Send confirmation email to admin
        // Mail::to(['enquiries@doghousebroga.com', 'doghousebroga@yahoo.com'])->queue((new Booking($booking))->from('enquiries@doghousebroga.com', 'Doghouse Broga'));
        Mail::to('keithgan96@gmail.com')->queue((new Booking($booking))->from('enquiries@doghousebroga.com', 'Doghouse Broga'));
